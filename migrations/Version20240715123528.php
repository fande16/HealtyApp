 ...
 */
final class Version20240715123528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE caisse (id INT NOT NULL, nom_caisse VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE consultation (id INT NOT NULL, patient_id INT DEFAULT NULL, medecin_id INT NOT NULL, constantes VARCHAR(255) NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, motif VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, resultat VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE examen_clinique (id INT NOT NULL, consultation_id INT NOT NULL, laboratin_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, resultat VARCHAR(255) NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE facturation (id INT NOT NULL, mode_paiement_id INT NOT NULL, caisse_id INT NOT NULL, consultation_id INT NOT NULL, montant DOUBLE PRECISION NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE hospitalisation (id INT NOT NULL, consultation_id INT NOT NULL, date_entre TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_sortie TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, chambre VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_67C0595962FF6CDF ON hospitalisation (consultation_id)');
        $this->addSql('CREATE TABLE infirmiere (id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE laboratin (id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE ligne_prescription (id INT NOT NULL, prescription_id INT NOT NULL, stock_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, quantite INT NOT NULL, posologie VARCHAR(255) NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE medecin (id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, age INT NOT NULL, adresse VARCHAR(255) NOT NULL, specialite VARCHAR(255) NOT NULL, telephone VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE medicament (id INT NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE mode_paiement (id INT NOT NULL, type_paiement VARCHAR(255) NOT NULL, mwthode VARCHAR(255) NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE patient (id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, age INT NOT NULL, sex VARCHAR(255) NOT NULL, gs VARCHAR(255) NOT NULL, mobile VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE pharmacien (id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE prescription (id INT NOT NULL, consultation_id INT DEFAULT NULL, pharmacien_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, posologie VARCHAR(255) NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE prise_service (id INT NOT NULL, caisse_id INT NOT NULL, date_debut TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_fin TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_AD15D36627B4FEBF ON prise_service (caisse_id)');
        $this->addSql('CREATE TABLE rdv (id INT NOT NULL, patient_id INT NOT NULL, caisse_id INT NOT NULL, consultation_id INT NOT NULL, date_prise TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_rdv TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, motif VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE receptioniste (id INT NOT NULL, prise_service_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_E4F0CDD7EDD30038 ON receptioniste (prise_service_id)');
        $this->addSql('CREATE TABLE soins (id INT NOT NULL, infirmiere_id INT NOT NULL, hospitalisation_id INT NOT NULL, constante VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE stock (id INT NOT NULL, medicament_id INT NOT NULL, quantite INT NOT NULL, prix INT NOT NULL, PRIMARY KEY(id))');
